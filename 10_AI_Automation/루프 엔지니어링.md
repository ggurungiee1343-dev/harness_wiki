...
created: 2026-06-10
description: "루프 엔지니어링은 사용자가 프롬프트를 직접 입력하는 대신 시스템이 스스로 프롬프트를 생성하도록 설계하는 방법이다. 목표를 정의하고 AI가 반복적으로 작업을 수행해 완성될 때까지 진행하는 재귀적 루프 구조를 사용한다. 현재 Claude Code와 Codex는 이 다섯 가지 핵심 블록을 모두 구현하고 있다."
tags: [ingested, 10_AI_Automation, loop-engineering, AI-automation, recursive-goal, Claude Code, Codex, prompting, system-design]
  - "clippings"
brief: "brief"
---

...
created: 2026-06-09
description: "2026년 2월, 소규모 OpenAI 팀이 수동 코드 작성 없이 AI 에이전트를 통해 100만 줄의 프로덕션 코드를 배포했다. 인간은 에이전트를 신뢰할 수 있게 만드는 시스템을 설계했으며, 이 시스템은 '하네스 엔지니어링'으로 명명되었다. Anthropic은 몇 주 내에 이 주제에 관한 3편의 논문을 발표하며 AI 엔지니어링 패러다임의 전환을 알렸다."
tags: [ingested, 10_AI_Automation, harness-engineering, ai-agents, openai, production-code, anthropic, automation, ai-engineering]
  - "clippings"
brief: "summary"
---

![이미지](https://pbs.twimg.com/media/HKMT253bsAAkeaf?format=jpg&name=large)
...
![이미지](https://pbs.twimg.com/media/HKMONPZbMAAuFzj?format=jpg&name=large)
...
![이미지](https://pbs.twimg.com/media/HKMOQ4-b0AAM8FP?format=jpg&name=large)
...
![이미지](https://pbs.twimg.com/media/HKMOVkEbcAA-to2?format=jpg&name=large)
...
![이미지](https://pbs.twimg.com/media/HKMOYwYacAAAoNm?format=jpg&name=large)
...
![이미지](https://pbs.twimg.com/media/HKMO0D7boAAYE9h?format=jpg&name=large)
...
![이미지](https://pbs.twimg.com/media/HKMO5MVaMAAHqik?format=jpg&name=large)
...
![이미지](https://pbs.twimg.com/media/HKMO9V1awAAFI8f?format=jpg&name=large)
...
![이미지](https://pbs.twimg.com/media/HKMPGK6asAAUILK?format=jpg&name=large)
...
![이미지](https://pbs.twimg.com/media/HKMPmclbcAAPPxQ?format=jpg&name=large)
...
![이미지](https://pbs.twimg.com/media/HKMPriAbAAA0jBO?format=jpg&name=large)
...
![이미지](https://pbs.twimg.com/media/HKMPvtSa4AALRwq?format=jpg&name=large)
...
![이미지](https://pbs.twimg.com/media/HKMQM19aoAAve50?format=jpg&name=large)
...
![이미지](https://pbs.twimg.com/media/HKMQURsbgAAEctZ?format=jpg&name=large)
...
![이미지](https://pbs.twimg.com/media/HKMQaebbwAA9wsx?format=jpg&name=large)
...
![이미지](https://pbs.twimg.com/media/HKMQhHbb0AAhevu?format=jpg&name=large)
...
![이미지](https://pbs.twimg.com/media/HKMQoZxacAAEuu7?format=jpg&name=large)
...
![이미지](https://pbs.twimg.com/media/HKMRQilasAAGqtY?format=jpg&name=large)
...
![이미지](https://pbs.twimg.com/media/HKMRWgEb0AAnYQE?format=jpg&name=large)
...
![이미지](https://pbs.twimg.com/media/HKMRa_2a4AAvh7S?format=jpg&name=large)
...
![이미지](https://pbs.twimg.com/media/HKMvHx_bQAA47bM?format=jpg&name=large)

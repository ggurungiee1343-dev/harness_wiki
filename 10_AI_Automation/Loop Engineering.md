...
created: 2026-06-09
description: "Loop engineering은 에이전트에게 프롬프트를 입력하는 인간을 대체하는 개념이다. 대신 시스템을 설계하여 반복적으로 작업을 수행하도록 한다. 이는 목적을 정의하면 AI가 완료될 때까지 반복하는 재귀적 목표로, Claude Code와 Codex에서 모두 구현되었다."
tags: [ingested, 10_AI_Automation, loop-engineering, ai-agent, automation, recursive-goal, claude-code, codex, workflow]
  - "clippings"
brief: "2줄 브리프"
---

![이미지](https://pbs.twimg.com/media/HKU_Us-bMAAZO3J?format=jpg&name=large)
...
![이미지](https://pbs.twimg.com/media/HKU_9kOakAEj0WP?format=png&name=large)
